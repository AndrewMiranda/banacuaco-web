export function createGaleryModal() {
    ...
    class galeryModal extends HTMLElement {
        ...
        static get observedAttributes(){
            return["hide", "url", "autor", "descen", "idioma"]
        }
        ...
        getTemplate() {
            ...
            if (this.idioma == "en") {
                this.idioma = "Description";
                this.title1 = "Author";
            }else{
                this.idioma = "Descripción";
                this.title1 = "Autor";
            }
            template.innerHTML =
                `<div id="alertModal">
                    <div class="containerAlert">
                        <div class="containerAlertA">
                            ...
                            <div class="textInfo">
                                <div class="titleAlert">${this.title1}</div>
                                <div class="descriptionText">${this.autor}</div>
                            </div>
                            <div class="textInfo">
                                <div class="titleAlert">${this.idioma}</div>
    ...
    window.customElements.define('galery-modalpage',  galeryModal);
};

export function cancel(){
    document.querySelector('galery-modalpage').remove();
};

export function launchModalGalery(url, autor, descen, idioma){
    let modal = document.createElement('galery-modalpage');
    modal.setAttribute("url", url);
    modal.setAttribute("autor", autor);
    modal.setAttribute("descen", descen);
    modal.setAttribute("idioma", idioma);
